...
import { LanguageCustomItem } from "@Models";

interface LanguageCustomProps {
  data: LanguageCustomItem[];
  onSuccess: () => void;
}

export const LanguageCustom: React.FC<LanguageCustomProps> = ({
  data,
  onSuccess,
}) => {
  ...
  const onFinish = (values) => {
    ...
    axios
      .post("http://localhost:8080/api/custom", values)
      .then((response) => {
